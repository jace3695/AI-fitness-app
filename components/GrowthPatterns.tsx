...
export default function GrowthPatterns({ routines, sessions, ready, loading, onRefresh }: {
  routines: GrowthRoutineRow[]; sessions: GrowthSessionRow[]; ready: boolean; loading: boolean; onRefresh: () => Promise<void>;
}) {
