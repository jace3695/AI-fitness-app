...
export default function LearningQuestion({ lesson, index, mode, answer, response, onAnswer, onRetry, onHint, play, playing }: {
  ...
  return <div>
    ...
    {answer !== undefined && <div className={styles.feedback} data-correct={answer} role="status">
