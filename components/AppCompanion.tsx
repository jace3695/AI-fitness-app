...
function AppCompanion({ children, compact = false, home = false, action = "idle", quiet = false }: {
  children: ReactNode;
  compact?: boolean;
  home?: boolean;
  action?: YeoniAction;
  ...
  return <aside className={styles.guide} data-compact={compact} data-home={home} data-character={preferences.visible} aria-label="연이의 안내">
