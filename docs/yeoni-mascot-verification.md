...
최신 상태: 아래 이력 이후 음성 성공 재생과 320·390px 학습·설정 화면의 사용자 영상 재검증을 완료했다. 후속 결과와 직접 검증하지 않은 범위는 [공통 TOP 및 후속 실사용 검증](common-scroll-top-verification.md)의 마지막 절을 참고한다.
