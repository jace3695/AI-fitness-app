...
const APPS = {
  assistant: { label: "제이스비서", Icon: Bot, tone: "bg-violet-100 text-violet-700", image: "/app-icons/assistant.png" },
...
export function AppIcon({ kind, className = "h-10 w-10" }: { kind: AppKind; className?: string }) {
  ...
  const image = kind === "assistant" ? "/app-icons/assistant.png" : kind === "budget" ? "/app-icons/budget-ai-ledger-v3.png" : kind === "fitness" ? "/app-icons/fitness.png" : kind === "language" ? "/app-icons/language.png" : null;
