...
export default function WorkoutNotificationPanel() {
  ...
  return <section className="mb-4 rounded-3xl border border-gray-100 bg-white p-5 shadow-sm sm:p-6">
    ...
    <label className="mt-4 flex items-center justify-between gap-3 rounded-xl bg-gray-50 px-3 py-3 text-sm font-bold text-gray-700">운동 시작 시간<input type="time" value={settings.time} onChange={(event) => persist({ ...settings, time: event.target.value })} className="rounded-lg border border-gray-200 bg-white px-3 py-2" /></label>
