...
const modules = [
  { href: "/assistant", title: "AI 연이", description: "일정·할 일·통합 브리핑", status: "메인", color: "bg-[#EEF3FF] text-[#355B9C]" },
    ...
    <main className="min-h-dvh bg-[#F5F4FA] pb-24 text-[#242231] md:pb-0">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-lg font-bold">AI 연이</h1>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-7 sm:px-6 sm:py-10">
        <section className="overflow-hidden rounded-[30px] bg-gradient-to-br from-[#5146A6] to-[#766DCE] p-6 text-white shadow-[0_22px_55px_rgba(81,70,166,0.22)] sm:p-9">
          ...
          <p className="mt-3 max-w-xl text-sm leading-6 text-white/80">오늘 할 일부터 소비·운동·언어 복습까지 연이와 한 화면에서 확인하세요.</p>
          <Link href="/assistant" className="mt-6 flex items-center justify-between rounded-2xl bg-white/12 p-4 text-sm font-semibold ring-1 ring-white/20 transition hover:bg-white/20"><span>연이에게 오늘 할 일을 정리해 달라고 해보세요</span><span className="font-bold">열기 →</span></Link>
        </section>
