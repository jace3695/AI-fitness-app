...
export const WORKOUT_GROUPS: WorkoutGroup[] = [
  ...
  { id: 'rest', name: '휴식', category: 'rest', goal: '피로 회복, 허리 보호', duration: '휴식', intensity: 'low', exercises: [
    { exerciseId: 'complete-rest', name: '완전 휴식' }, { exerciseId: 'pullup-posture-only', name: '턱걸이 자세 연습 1~2분', description: '휴식을 우선하고, 원할 때만 자세 연습을 선택합니다. 쉬고 싶으면 건너뛰세요.' }, { exerciseId: 'foam-roller-recovery-if-needed', name: '폼롤러 회복 5분', description: '필요할 때만 선택하는 회복 운동입니다. 필요하지 않으면 건너뛰세요.' },
  ] },
];
