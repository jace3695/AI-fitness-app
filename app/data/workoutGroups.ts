...
export const WORKOUT_GROUPS: WorkoutGroup[] = [
  ...
  { id: 'cardio-core-basic', name: '유산소 + 코어 안정화', category: 'core', goal: '허리 안정성, 복부 힘 회복, AB 슬라이더 준비', duration: '약 45~55분', intensity: 'low', exercises: [
    { exerciseId: 'foam-roller-prep', name: '폼롤러 준비', duration: '3분' }, { exerciseId: 'basic-warmup', name: '기본 몸풀기', duration: '3~5분' }, { exerciseId: 'pre-rosary-sliding-board', name: '운동 전 묵주기도 슬라이딩보드', duration: '1주차 15분 · 2주차 15~20분 · 3주차 이후 20분', description: '기도와 저강도 유산소를 함께하는 운동 전 준비 시간입니다. 묵주기도를 이어갈 수 있을 정도의 가벼운 속도로 진행하세요.' }, { exerciseId: 'dead-bug', name: '데드버그', sets: '좌우 6회 × 2세트' }, { exerciseId: 'knee-side-plank', name: '무릎 사이드 플랭크', sets: '좌우 10~15초 × 2세트' }, { exerciseId: 'ab-slider-ready-position', name: 'AB 슬라이더 준비 자세', sets: '5초 버티기 × 3회', description: '무릎 대고 잡기 · 복부 힘 주기 · 1~2주차에는 앞으로 밀지 않음', cautions: ['허리 통증이나 다리 저림이 있으면 제외'] }, { exerciseId: 'pullup-basic-posture', name: '턱걸이 초기자세', duration: '3~5분' }, { exerciseId: 'post-sliding-board', name: '운동 후 슬라이딩보드 마무리', duration: '1~2주차 5분 또는 생략 가능 · 3~4주차 10분 · 5주차 이후 컨디션 좋으면 15~20분', description: '운동 후 슬라이딩보드는 감량 보조용입니다. 처음 1~2주차에는 5분만 진행하고, 허리/무릎 통증이 없을 때 10분 이상으로 늘립니다. 피곤하거나 허리/무릎 부담이 있으면 생략해도 됩니다.' }, { exerciseId: 'basic-cooldown', name: '기본 정리운동', duration: '3~5분' }, { exerciseId: 'foam-roller-recovery', name: '폼롤러 회복', duration: '5분' },
  ] },
  ...
  { id: 'optional-cardio', name: '선택 유산소', category: 'cardio', goal: '체지방 감량 보조, 활동량 증가', duration: '선택 20~30분', intensity: 'low', exercises: [
    { exerciseId: 'sliding-board-20-30', name: '슬라이딩보드 20~30분' }, { exerciseId: 'rosary-sliding-board', name: '묵주기도 슬라이딩보드 15~20분', duration: '15~20분' }, { exerciseId: 'indoor-outdoor-walk', name: '실내 걷기/야외 산책' }, { exerciseId: 'rest-option', name: '휴식' },
  ] },
