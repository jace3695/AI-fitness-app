...
export const exerciseGuides: Record<string, ExerciseGuideEntry> = {
  ...
  '운동 전 슬라이딩보드': { summary: '대화 가능한 강도로 몸을 데우는 운동 전 유산소', purpose: '저강도 유산소로 체온을 올리고 본운동을 준비합니다.', setup: ['슬라이딩보드 위에 안정적으로 올라섭니다.', '균형이 흔들리면 벽이나 손잡이 가까이에서 시작합니다.'], movement: ['슬라이딩보드 위에서 천천히 좌우로 이동합니다.', '처음 2~3분은 아주 가볍게 시작합니다.', '대화가 가능한 정도의 속도를 유지합니다.', '숨이 너무 차면 속도를 줄입니다.', '허리나 무릎 통증이 있으면 즉시 중단합니다.'], breathing: '대화가 가능한 정도로 편하게 호흡합니다.', target: '체온 상승, 저강도 유산소, 감량 보조', commonMistakes: ['처음부터 빠르게 움직임', '균형이 흔들리는데 속도를 유지함'], stopCriteria: ['운동 전부터 지칠 정도로 빠르게 하지 마세요.', '균형이 흔들리면 속도를 낮추세요.', '대화하기 어려운 강도라면 속도를 낮추세요.'], alternatives: ['제자리 걷기', '실내 걷기'], keyPoint: '대화가 가능한 강도가 오늘의 적정 강도입니다.' },
  '회복 슬라이딩보드': { summary: '회복을 방해하지 않는 저강도 슬라이딩보드', purpose: '가볍게 체온을 올리고 회복을 방해하지 않는 유산소를 진행합니다.', setup: ['슬라이딩보드 위에 안정적으로 올라섭니다.'], movement: ['천천히 좌우 이동합니다.', '대화가 가능한 속도를 유지합니다.', '컨디션이 좋으면 5분만 추가합니다.'], breathing: '대화가 가능한 편한 호흡을 유지합니다.', target: '저강도 유산소와 회복', commonMistakes: ['회복일에 강도를 높임'], stopCriteria: stopDefault, keyPoint: '회복일에는 가볍게 끝내는 것이 목표입니다.' },
  '버드독': { summary: '허리 안정화와 코어 조절을 돕는 운동', purpose: '허리 안정화, 코어 조절, 골반 흔들림 감소', setup: ['네발기기 자세를 만듭니다.', '손은 어깨 아래, 무릎은 골반 아래에 둡니다.'], movement: ['배에 힘을 주고 허리를 중립으로 유지합니다.', '오른팔과 왼다리를 천천히 뻗습니다.', '몸통이 흔들리지 않게 1~2초 유지합니다.', '천천히 돌아와 반대쪽도 진행합니다.'], breathing: '뻗을 때 숨을 내쉬고, 돌아올 때 들이마십니다.', target: '허리 안정화, 코어 조절, 골반 흔들림 감소', commonMistakes: ['허리가 꺾임', '다리를 높이 차올림'], stopCriteria: ['허리가 꺾이면 팔 또는 다리만 따로 진행하세요.', '다리를 높이 차올리지 마세요.', '다리 저림이 있으면 중단하세요.'], alternatives: ['팔만 번갈아 뻗기', '다리만 번갈아 뻗기'], keyPoint: '높이보다 몸통이 흔들리지 않는 것이 중요합니다.' },
  '힙브릿지': { summary: '엉덩이 근육을 깨워 허리 부담을 줄이는 운동', purpose: '엉덩이 근육 활성화, 허리 부담 감소, 골반 안정화', setup: ['바닥에 누워 무릎을 세웁니다.', '발은 골반 너비로 벌리고 발바닥을 바닥에 둡니다.'], movement: ['배에 힘을 주고 엉덩이를 조입니다.', '허리를 꺾지 않고 엉덩이를 천천히 들어 올립니다.', '위에서 1초 멈춘 뒤 천천히 내려옵니다.'], breathing: '올릴 때 숨을 내쉬고 내려오며 들이마십니다.', target: '둔근, 골반 안정성', commonMistakes: ['허리로 들어 올림', '무릎이 안쪽으로 모임'], stopCriteria: ['허리로 들어 올리지 말고 엉덩이 힘으로 올리세요.', '허리가 뻐근하면 높이를 낮추세요.', '무릎이 안쪽으로 모이지 않게 하세요.'], alternatives: ['골반 기울이기', '엉덩이 힘주기 5초 유지'], keyPoint: '허리가 아니라 엉덩이 힘으로 들어 올립니다.' },
  '데드버그': { summary: '누운 자세에서 복부 안정성을 회복하는 운동', purpose: '복부 안정화, 허리 중립 유지, 코어 조절', setup: ['바닥에 누워 양팔을 천장으로 올립니다.', '무릎을 90도로 들어 올립니다.'], movement: ['허리가 바닥에서 과하게 뜨지 않게 복부에 힘을 줍니다.', '오른팔과 왼다리를 천천히 멀리 뻗습니다.', '허리가 뜨기 전 범위까지만 움직입니다.', '천천히 돌아와 반대쪽도 진행합니다.'], breathing: '팔다리를 뻗을 때 숨을 내쉽니다.', target: '복부 안정화, 허리 중립 유지', commonMistakes: ['허리가 뜸', '빠르게 움직임'], stopCriteria: ['허리가 뜨면 다리를 멀리 뻗지 마세요.', '빠르게 하지 마세요.', '허리 통증이 있으면 팔만 움직이세요.'], alternatives: ['팔만 번갈아 내리기', '발뒤꿈치 바닥 톡톡'], keyPoint: '허리가 뜨기 전까지만 작게 움직입니다.' },
  ...
  'AB 슬라이더 준비 자세': { summary: 'AB 슬라이더 전 복부 힘과 허리 안정성을 확인', purpose: 'AB 슬라이더를 하기 전 복부 힘과 허리 안정성을 확인합니다.', setup: ['무릎을 바닥에 대고 AB 슬라이더를 양손으로 잡습니다.', '배에 힘을 주고 갈비뼈가 들리지 않게 합니다.'], movement: ['허리가 아래로 꺾이지 않게 중립을 유지합니다.', '1~2주차에는 앞으로 밀지 않고 시작 자세만 5초 유지합니다.', '통증이 없을 때만 3~4주차부터 10~20cm 짧게 밀 수 있습니다.'], breathing: '버티는 동안 숨을 참지 말고 짧게 내쉽니다.', target: '복부 힘, 허리 안정성', commonMistakes: ['처음부터 멀리 밈', '복부 힘이 풀림'], stopCriteria: ['허리 통증 또는 다리 저림이 있으면 즉시 중단하세요.', '처음부터 멀리 밀지 마세요.', '복부 힘이 풀리면 중단하세요.'], alternatives: ['데드버그', '골반 기울이기'], keyPoint: '준비 자세가 안정적일 때만 짧게 진행합니다.' },
...
const exerciseIdByName: Record<string, string> = {
  ...
  '회복 슬라이딩보드': 'rosary-sliding-board',
  '버드독': 'bird-dog',
  '힙브릿지': 'hip-bridge',
  '데드버그': 'dead-bug',
  '캣카우': 'cat-cow',
