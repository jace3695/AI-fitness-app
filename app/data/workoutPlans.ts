...
export const WEEKLY_WORKOUT_PLANS: WeeklyWorkoutPlan[] = [
  { id: 'week1-cardio-back', name: '1주차 — 유산소 + 허리 강화 적응 주간', description: '운동 재시작, 허리 안정화, 슬라이딩보드 적응, 폼롤러 사용 습관, 과한 근력운동 전 준비.', recommendedFor: '운동을 3개월 정도 쉬었거나 허리 부담이 걱정되는 사용자', weekLabel: '1주차', notice: '첫 1주일은 유산소와 허리 강화 운동 중심으로 진행합니다. 최근 운동을 쉬었거나 허리 부담이 걱정된다면 덤벨 운동을 바로 늘리기보다, 슬라이딩보드와 허리 안정화 운동으로 몸을 먼저 적응시키는 것을 추천합니다.', days: { monday: 'cardio-back-basic', tuesday: 'cardio-foam-recovery', wednesday: 'cardio-back-basic', thursday: 'cardio-core-basic', friday: 'cardio-back-basic', saturday: 'optional-cardio', sunday: 'rest' } },
