...
const GUIDE_LIBRARY: Record<string, ExerciseGuide> = {
  ...
  "롱밴드 랫풀다운": {
    ...
    keyPoint: "팔보다 팔꿈치를 아래로 내리며 등을 먼저 쓴다.",
  ...
  "롱밴드 로우": {
    ...
    keyPoint: "허리는 고정하고 팔꿈치가 몸 뒤로 간다는 느낌으로 당긴다.",
  ...
  "루프밴드 풀어파트": {
    ...
    keyPoint: "어깨를 내리고 등 위쪽으로 밴드를 벌린다.",
  ...
  "루프밴드 사이드 워크": {
    ...
    keyPoint: "작은 보폭으로 밴드 장력을 유지하고 골반 높이를 일정하게 둔다.",
  ...
  "루프밴드 몬스터 워크": {
    ...
    keyPoint: "작은 대각선 걸음으로 엉덩이 옆 힘을 계속 유지한다.",
  ...
  "롱밴드 페이스풀": {
    ...
    keyPoint: "얼굴 쪽으로 당기되 목이 아니라 어깨 뒤쪽과 등 위쪽을 쓴다.",
  ...
  adapt2: day(
    ...
    [
      ...
      mk(
        "의자 스쿼트",
        "10회 × 2세트 · 휴식 45초",
        "의자에 가볍게 앉았다 일어나며 무릎과 허리 통증 없는 범위만 진행합니다.",
        2,
        45,
      ),
      mk(
  ...
  adapt3: day(
    ...
    [
      ...
      mk(
        "덤벨 플로어 프레스",
        "10회 × 2세트 · 휴식 45초",
        "한 손 3~5kg부터 시작하고 무게 욕심을 내지 않습니다.",
        2,
        45,
      ),
      mk(
        "루프밴드 풀어파트",
        "12~15회 × 2세트 · 휴식 30초",
        "어깨를 내리고 등 위쪽으로 밴드를 벌립니다.",
        2,
        30,
      ),
      mk(
        "무릎 사이드 플랭크",
        "좌우 10~15초 × 2세트 · 휴식 30초",
        "오래 버티지 말고 허리 통증 없는 짧은 자세만 유지합니다.",
        2,
        30,
      ),
      PULLUP_START(),
...
export const WORKOUTS: DayWorkout[] = [
  day(
    ...
    "💪",
    "월요일 — 운동 A: 허리 안정화 + 등",
    "총 15~20분 · 턱걸이 초기자세 3분 포함",
    ADAPTATION_WORKOUTS.adapt1.phases[1].exercises,
    "#534AB7",
  ),
  day(
    "tue",
    "화요일",
    "🚶",
    "화요일 — 가벼운 유산소 + 턱걸이 초기자세",
    "가벼운 유산소 15~20분 중심",
    [
      mk(
        "가벼운 유산소",
        "15~20분",
        "걷기 대신 슬라이딩보드, 실내 걷기, 고정식 자전거 등으로 대체할 수 있습니다.",
        0,
        0,
      ),
      mk(
        "턱걸이 초기자세 연습",
        "3분",
        "최대 버티기가 아니라 철봉 잡기·발 보조 매달리기·견갑 내리기 감각만 짧게 연습합니다.",
        0,
        0,
      ),
    ],
  ...
  day(
    ...
    "수요일 — 운동 B: 하체 + 골반 안정",
    "총 15~20분 · 턱걸이 초기자세 3분 포함",
    ADAPTATION_WORKOUTS.adapt2.phases[1].exercises,
    "#639922",
  ),
  day(
    "thu",
  ...
  day(
    ...
    "금요일 — 운동 C: 상체 + 코어 안정화",
    "총 15~20분 · 턱걸이 초기자세 3분 포함",
    ADAPTATION_WORKOUTS.adapt3.phases[1].exercises,
    "#EF9F27",
  ),
  day(
    "sat",
    ...
    [
      sliding(
        "선택 유산소",
        "10~20분",
        "슬라이딩보드를 1순위로 추천하고, 실내 걷기·야외 걷기·고정식 자전거·기타 가벼운 유산소 중 선택합니다.",
        { segments: [{ label: "가볍게", seconds: 600, intensity: "가볍게" }] },
      ),
      mk("턱걸이 초기자세 연습", "3분", "짧은 자세 연습만 진행합니다.", 0, 0),
    ],
    "#E24B4A",
  ),
  day(
    ...
    "일요일",
    "😴",
    "일요일 — 휴식 또는 턱걸이 자세만 1~2분",
    "회복 중심 · 필요 시 짧은 자세 확인만 진행",
    [
      mk("휴식", "권장", "몸 상태를 회복하고 다음 주 운동을 준비합니다.", 0, 0),
      mk(
        "턱걸이 자세 확인",
        "1~2분",
        "통증이 없을 때만 철봉 잡기와 견갑 내리기 감각을 짧게 확인합니다.",
        0,
        0,
      ),
    ],
...
export const WEEK_OVERVIEW = {
  stats: [
    { label: "묵주기도 유산소", value: "20", unit: "분", sub: "3주차 이후" },
    { label: "근력/안정화", value: "3", unit: "일", sub: "월·수·금" },
    { label: "마무리 유산소", value: "5~20", unit: "분", sub: "단계적 증가" },
    { label: "턱걸이 초기자세", value: "매일", unit: "", sub: "3~5분" },
  ],
  days: [
    {
      day: "월",
