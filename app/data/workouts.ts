...
> = {
  adapt1: day(
    ...
    [
      ...
      mk("덤벨 원암 로우", "좌우 10회 × 2세트 · 5~7kg부터", "상체를 흔들지 말고 등을 조이며 가벼운 무게로 시작합니다.", 2, 45),
  ...
  adapt3: day(
    ...
    [
      ...
      mk("힙브릿지", "12회 × 2세트", "허리가 아니라 엉덩이에 힘을 주고 과하게 젖히지 않습니다.", 2, 30),
      mk("데드버그", "좌우 6회 × 2세트", "허리가 뜨지 않는 범위에서 팔다리를 천천히 움직입니다.", 2, 30),
      mk("AB 슬라이더 준비 자세", "무릎 대고 잡기 · 복부 힘 주기 · 5초 버티기 × 3회 · 앞으로 밀지 않음", "1~2주차에는 앞으로 밀지 않습니다. 허리가 꺾이거나 다리 저림이 있으면 즉시 제외합니다.", 0, 0, undefined, true),
