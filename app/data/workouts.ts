...
export const WEEK_OVERVIEW = {
  ...
  days:[{day:'월',emoji:'💪',label:'운동 A',sub:'허리·등',time:'15~20분',active:true,tabId:'mon',color:'#534AB7',bg:'#EEEDFE',border:'#AFA9EC'},{day:'화',emoji:'🚶',label:'식후 걷기',sub:'자세 3분',time:'15~20분',active:true,tabId:'tue',color:'#378ADD',bg:'#E6F1FB',border:'#9CCAF0'},{day:'수',emoji:'🌿',label:'운동 B',sub:'하체·골반',time:'15~20분',active:true,tabId:'wed',color:'#639922',bg:'#EAF3DE',border:'#B7D88B'},{day:'목',emoji:'🚶',label:'식후 걷기',sub:'자세 3분',time:'15~20분',active:true,tabId:'thu',color:'#378ADD',bg:'#E6F1FB',border:'#9CCAF0'},{day:'금',emoji:'⚡',label:'운동 C',sub:'상체·코어',time:'15~20분',active:true,tabId:'fri',color:'#EF9F27',bg:'#FAEEDA',border:'#F3C276'},{day:'토',emoji:'🌤️',label:'선택',sub:'보드/산책',time:'10~15분',active:true,tabId:'sat',color:'#E24B4A',bg:'#FCEBEB',border:'#F1A6A6'},{day:'일',emoji:'😴',label:'휴식',sub:'자세 1~2분',time:'휴식',active:false}],
  dayTimes:[{days:'월',total:'15~20분',detail:'운동 A',color:'#534AB7',border:'#AFA9EC'},{days:'화',total:'15~20분',detail:'식후 걷기',color:'#378ADD',border:'#9CCAF0'},{days:'수',total:'15~20분',detail:'운동 B',color:'#639922',border:'#B7D88B'},{days:'목',total:'15~20분',detail:'식후 걷기',color:'#378ADD',border:'#9CCAF0'},{days:'금',total:'15~20분',detail:'운동 C',color:'#EF9F27',border:'#F3C276'},{days:'토',total:'10~15분',detail:'선택 유산소',color:'#E24B4A',border:'#F1A6A6'}]
};
