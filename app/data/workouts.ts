...
export const WORKOUTS: DayWorkout[] = [
  ...
  day('tue','화요일','🚶','화요일 — 식후 걷기 + 턱걸이 초기자세','식후 걷기 15~20분 중심', [mk('식후 걷기','15~20분','숨은 차지만 대화 가능한 정도로 걷습니다.',0,0), mk('턱걸이 초기자세 연습','3분','최대 버티기가 아니라 철봉 잡기·발 보조 매달리기·견갑 내리기 감각만 짧게 연습합니다.',0,0)], '#378ADD'),
  day('wed','수요일','🌿','수요일 — 운동 B: 하체 + 골반 안정','총 15~20분 · 턱걸이 초기자세 3분 포함', ADAPTATION_WORKOUTS.adapt2.phases[1].exercises, '#639922'),
  day('thu','목요일','🚶','목요일 — 식후 걷기 + 턱걸이 초기자세','식후 걷기 15~20분 중심', [mk('식후 걷기','15~20분','컨디션이 좋지 않으면 10분 산책으로 낮춥니다.',0,0), mk('턱걸이 초기자세 연습','3분','반동 없이 어깨를 귀에서 멀리 두는 감각만 확인합니다.',0,0)], '#378ADD'),
  day('fri','금요일','⚡','금요일 — 운동 C: 상체 + 코어 안정화','총 15~20분 · 턱걸이 초기자세 3분 포함', ADAPTATION_WORKOUTS.adapt3.phases[1].exercises, '#EF9F27'),
  day('sat','토요일','🌤️','토요일 — 선택 유산소 + 턱걸이 초기자세','컨디션 좋으면 슬라이딩보드 10~15분 또는 산책', [sliding('선택 슬라이딩보드','10~15분','컨디션이 좋은 날만 가볍게 진행하고 아니면 산책으로 대체합니다.',{segments:[{label:'가볍게',seconds:600,intensity:'가볍게'}]}), mk('산책','10~20분','슬라이딩보드가 부담되면 산책을 선택합니다.',0,0), mk('턱걸이 초기자세 연습','3분','짧은 자세 연습만 진행합니다.',0,0)], '#E24B4A'),
...
export const WEEK_OVERVIEW = {
  stats:[{label:'근력/안정화',value:'3',unit:'일',sub:'월·수·금'},{label:'본운동',value:'15~25',unit:'분',sub:'처음 2주'},{label:'걷기/가벼운 유산소',value:'3~5',unit:'회',sub:'화·목·토 선택'},{label:'턱걸이 초기자세',value:'매일',unit:'',sub:'3~5분'}],
  days:[{day:'월',emoji:'💪',label:'운동 A',sub:'허리·등',time:'15~20분',active:true,tabId:'mon',color:'#534AB7',bg:'#EEEDFE',border:'#AFA9EC'},{day:'화',emoji:'🚶',label:'식후 걷기',sub:'자세 3분',time:'15~20분',active:true,tabId:'tue',color:'#378ADD',bg:'#E6F1FB',border:'#9CCAF0'},{day:'수',emoji:'🌿',label:'운동 B',sub:'하체·골반',time:'15~20분',active:true,tabId:'wed',color:'#639922',bg:'#EAF3DE',border:'#B7D88B'},{day:'목',emoji:'🚶',label:'식후 걷기',sub:'자세 3분',time:'15~20분',active:true,tabId:'thu',color:'#378ADD',bg:'#E6F1FB',border:'#9CCAF0'},{day:'금',emoji:'⚡',label:'운동 C',sub:'상체·코어',time:'15~20분',active:true,tabId:'fri',color:'#EF9F27',bg:'#FAEEDA',border:'#F3C276'},{day:'토',emoji:'🌤️',label:'선택',sub:'보드/산책',time:'10~15분',active:true,tabId:'sat',color:'#E24B4A',bg:'#FCEBEB',border:'#F1A6A6'},{day:'일',emoji:'😴',label:'휴식',sub:'자세 1~2분',time:'휴식',active:true,tabId:'sun',color:'#6B7280',bg:'#F3F4F6',border:'#D1D5DB'}],
  dayTimes:[{days:'월',total:'15~20분',detail:'운동 A',color:'#534AB7',border:'#AFA9EC'},{days:'화',total:'15~20분',detail:'식후 걷기',color:'#378ADD',border:'#9CCAF0'},{days:'수',total:'15~20분',detail:'운동 B',color:'#639922',border:'#B7D88B'},{days:'목',total:'15~20분',detail:'식후 걷기',color:'#378ADD',border:'#9CCAF0'},{days:'금',total:'15~20분',detail:'운동 C',color:'#EF9F27',border:'#F3C276'},{days:'토',total:'10~15분',detail:'선택 유산소',color:'#E24B4A',border:'#F1A6A6'},{days:'일',total:'휴식',detail:'자세 1~2분',color:'#6B7280',border:'#D1D5DB'}]
};
