...
function DietApp() {
  return (
    <main className="min-h-dvh bg-[#F6F7FB]">
      ...
      <div className="mx-auto max-w-6xl px-4 py-5 sm:px-6"><AppCompanion home>식사 사진을 올려봐요. 음식과 양도 확인해 주세요.</AppCompanion><DietView /><div className="mt-5"><CloudSyncPanel /></div></div>
    </main>
  );
}
