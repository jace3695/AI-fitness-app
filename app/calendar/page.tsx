...
function UnifiedCalendar() {
  ...
  return <main className="min-h-dvh bg-[#F6F7FB] text-[#242231]"><header className="app-module-header"><div className="app-module-header-inner"><AppIdentity kind="calendar" title="통합 달력" subtitle="모든 앱의 날짜별 기록" /></div></header><div className="mx-auto max-w-5xl px-4 py-7 sm:px-6 sm:py-10">
