    ...
    <div className="mx-auto max-w-5xl space-y-5 px-4 py-6">
      ...
      {owned && doc && <>
        ...
        <section className="drawing-card" aria-label="한 동작씩 보기">
          ...
          {doc.lesson.practice?.mode === "copy" ? <CopyPractice key={owned.id} attempt={owned} records={records.records} original={original} easy={easy || doc.short} disabled={records.busy} onChange={update} /> : <>
