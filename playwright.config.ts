...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'webkit-small', testMatch: ['**/mobile.spec.ts', '**/p2.spec.ts', '**/free-first.spec.ts', '**/free-advice.spec.ts', '**/budget-improvements.spec.ts', '**/budget-payment-plans.spec.ts', '**/zephyr-guard.spec.ts', '**/assistant-commands.spec.ts', '**/assistant-budget-commands.spec.ts', '**/chatgpt-connection.spec.ts'], dependencies: ['auth-preservation'], use: { ...devices['iPhone 13'] } },
  ],
  webServer: {
