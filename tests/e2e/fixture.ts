  ...
  qa: async ({ context }, runTest, testInfo) => {
    ...
    try {
      ...
      for (const account of accounts) {
        ...
        for (const table of ['budget_category_rules', 'budget_category_changes', 'budget_category_change_items', 'budget_profiles', 'budget_transactions', 'budget_income', 'budget_savings', 'growth_routines', 'growth_sessions', 'growth_ai_reviews'] as const) {
